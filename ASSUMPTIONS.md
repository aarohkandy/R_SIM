...
| A-0002 | Inputs | Real vehicle BOM/mass/material data is not present yet; placeholder YAML files are provided for schema exercise only. | Replace with measured BOM and material properties. |
