...
- Sample active pneumatic rocket simulation carries internal mass, airframe-hardware, and motor-mount hardware components that affect mass/CG inputs without changing external length, diameter, split markers, or aero geometry.
