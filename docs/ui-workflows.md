...
- Show fins, motors, rail buttons, internal masses, parachutes, streamers, and shock cords nested under their selected host in the design tree, with unattached subparts separated for repair.
